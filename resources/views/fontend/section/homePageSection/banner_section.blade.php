            ...
            <div class="image-container-wrapper">
                <div class="image-container">
                    <div class="slider-container">
                        <div class="slide" style="background-image: url('http://127.0.0.1:8000/assets/images/resource/fluid-1.jpg')"></div>

                        <div class="slide" style="background-image: url('http://127.0.0.1:8000/assets/images/resource/fluid-2.jpg')"></div>

                        <div class="slide" style="background-image: url('http://127.0.0.1:8000/assets/images/resource/fluid-3.jpg')"></div>
                    </div>
                </div>
            </div>
        </div>
