                        ...
                        <div class="col-sm-6">
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item  "><a href="javascript:void(0)">Edit slider Details</a> </li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form py-3">
                                        <form action="{{ route('slider-details.update',$sliderDetail->id)  }}" enctype="multipart/form-data" method="post">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <Textarea name="first_part" id="first_part"
                                                            class="form-control">{{ $sliderDetail->first_part }}</Textarea>
                                                        @error('first_part')
                                                            <h6 class="text-danger"> {{ $message }}</h6>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <Textarea name="second_part" id="second_part"
                                                            class="form-control">{{$sliderDetail->second_part}}</Textarea>
                                                        @error('second_part')
                                                            <h6 class="text-danger"> {{ $message }}</h6>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <Textarea name="third_part" id="third_part"
                                                            class="form-control">{{$sliderDetail->third_part}} </Textarea>
                                                        @error('third_part')
                                                            <h6 class="text-danger"> {{ $message }}</h6>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <Textarea name="forth_part" id="forth_part"
                                                            class="form-control">{{$sliderDetail->forth_part}} </Textarea>
                                                        @error('forth_part')
                                                            <h6 class="text-danger"> {{ $message }}</h6>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <Textarea name="fifth_part" id="fifth_part"
                                                            class="form-control">{{$sliderDetail->fifth_part}} </Textarea>
                                                        @error('fifth_part')
                                                            <h6 class="text-danger"> {{ $message }}</h6>
                                                        @enderror
                                                    </div>
