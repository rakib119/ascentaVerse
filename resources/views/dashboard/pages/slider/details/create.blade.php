                        ...
                        <div class="col-sm-6">
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Add Slider Details</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <h2>Add Slider Details</h2>
                                        <a href="{{ url()->previous() }}" class="btn btn-success">Back</a>
                                    </div>
                                    <div class="form py-3">
                                        <form action="{{ route('slider-details.store') }}" enctype="multipart/form-data" method="post">
                                            @csrf
                                            <div class="row">
