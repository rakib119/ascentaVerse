                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            ...
                                                            <select name="show_in" id="" class="form-control">
                                                                ...
                                                                <option {{old('show_in')=='home_slider_1'?'selected':""}} value="home_slider_1">Home Page slider 1</option>
                                                                <option {{old('show_in')=='home_slider_2'?'selected':""}} value="home_slider_2">Home Page slider 2</option>
                                                                <option {{old('show_in')=='our_team_slider_1'?'selected':""}} value="our_team_1">Our Team Page slider 1</option>
                                                                <option {{old('show_in')=='our_team_slider_2'?'selected':""}} value="our_team_2">Our Team Page slider 2</option>
                                                            </select>
                                                        @error('show_in')
                                                            <h6 class="text-danger"> {{ $message }}</h6>
                                                        @enderror
