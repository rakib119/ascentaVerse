                 ...
                 <div class="col-sm-6">
                     <div class="page-title">
                         ...
                         <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Fifth Section</a></li>
                        </ol>
                     </div>
                 </div>
             </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h2 class=" mb-4">Fifth Section List</h2>
                                    </div>
                                    <div class="float-end d-none d-sm-block">
                                        <a href="{{route('about-fifth.create')}}" class="btn btn-success">Add Item</a>
                                    </div>
                                </div>
                                <table id="myTable" class="table table-centered table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ Str::substr($item->short_description, 0, 150)."..." }}</td>
                                                ...
                                                <button type="button" class="btn btn-primary has-arrow dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                   Action <i class="fas fa-angle-down"></i>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                       <li><a class="dropdown-item" href="{{route('about-fifth.edit',$item->id)}}">Edit</a>
                                                       <li>
                                                            <form id="deleteData{{$item->id}}" action="{{ route('about-fifth.destroy', $item->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
